//load matrix
//LU factorization A = L.U, L(U*X) = b
//calc first matrix --> forwards substitution matrix row*column multiplication for each cell, Lc = b
/*
DO I = 1, N
    PIVOT = A(I, I) 
    DO J = I+1, N
    ...
    ENDDO
ENDDO
//calc second matrix --> backwards substitution Ux = c
